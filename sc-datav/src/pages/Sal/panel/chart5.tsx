...
export default function Chart5({ refreshToken }: { refreshToken?: number }) {
  ...
  return (
    <SeamVirtualScroll
      ...
      column={[
        { title: "", dataIndex: "value1", noScroll: true },
        { title: "品种", dataIndex: "value2", noScroll: true },
        { title: "规格", dataIndex: "value3", noScroll: true },
        { title: "数量(万株)", dataIndex: "value4", align: "right", noScroll: true },
      ]}
