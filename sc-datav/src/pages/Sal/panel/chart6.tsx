...
export default function Chart6() {
  ...
  useRafInterval(() => {
    if (chartRef.current) {
      chartRef.current?.dispatchAction({ type: "showTip", seriesIndex: 0, dataIndex: tipIndex.current });
    ...
    <Chart<BarOption>
      ...
      option={{
        tooltip: {
          ...
          borderWidth: 1,
          borderRadius: 8,
          textStyle: { color: "rgba(0, 0, 0,0.8)", fontSize: 13, align: "left" },
        ...
        series: [
          {
            ...
            itemStyle: {
              ...
              color: {
                ...
                colorStops: colors.map((c, i) => ({ offset: i, color: c })),
                global: false,
              },
            },
            data: data,
