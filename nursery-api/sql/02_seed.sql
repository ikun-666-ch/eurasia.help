...
-- 默认密码均为 123456（BCrypt）
-- $2a$10$N9qo8uLOickgx2ZMRZoMyeIjZRGdjGj/n3.rsF2K9xK9Y5K9Y5K9Yu 占位，由应用启动时 DataInitializer 写入

DELETE FROM sales_order_item;
DELETE FROM sales_order;
DELETE FROM stock_record;
DELETE FROM inventory_stock;
DELETE FROM inventory_sku;
DELETE FROM finance_monthly;
DELETE FROM customer;
DELETE FROM seedling_category;
...
INSERT INTO inventory_stock (sku_id, warehouse, city, quantity) VALUES
(1, '主仓库', '西安市', 45.20),
(2, '主仓库', '西安市', 51.60),
(3, '东库', '宝鸡市', 50.10),
(4, '东库', '汉中市', 47.70),
...
INSERT INTO stock_record (sku_id, record_type, quantity, remark) VALUES
(1, 'IN',  20.00, '春季补苗入库'),
(2, 'OUT', 5.50,  '市政绿化出库'),
(3, 'IN',  15.00, '采购入库'),
(4, 'CHECK', 0.00, '月度盘点');

INSERT INTO sales_order (order_no, customer_id, status, total_amount, satisfaction, salesperson_id) VALUES
('SO202506001', 1, 'DONE', 128000.00, 5, NULL),
('SO202506002', 2, 'SHIPPING', 86000.00, 4, NULL),
('SO202506003', 3, 'CONFIRMED', 215000.00, 5, NULL);
